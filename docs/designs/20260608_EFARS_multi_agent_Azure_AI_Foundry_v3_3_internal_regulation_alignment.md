# EFARS 멀티에이전트 — Azure AI Foundry **A2A 전용** Low-Code 설계서 v3.3

> 코드 없이 **Foundry 포털 UI** + **A2A Tool**만으로 구축. Workflow 사용 안 함.
> 작성일: 2026-06-08 (KST) · 설계 버전: **v3.3 (Internal Regulation Alignment Edition — 사내 「전자금융 IT사고·장애 대응 규정」 정렬)**
> 이전 버전: [v3.2 A2A Executive Report](./20260606_EFARS_multi_agent_Azure_AI_Foundry_v3_2_A2A_executive_report.md) · [v3.1 A2A Edition](./20260605_EFARS_multi_agent_Azure_AI_Foundry_v3_1_A2A.md) · [v3.0 A2A Edition](./20260605_EFARS_multi_agent_Azure_AI_Foundry_v3_A2A.md)

---

## 0. v3.3가 v3.2와 다른 점 (변경 요약)
...
## 10. 검증 출처 (Microsoft Learn 1차 문서 — v3.2와 동일)
